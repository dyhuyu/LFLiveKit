...
- (instancetype)initWithVideoStreamConfiguration:(LFLiveVideoConfiguration *)configuration {
    if (self = [super init]) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(disEnterBackground:) name:UIApplicationDidEnterBackgroundNotification object:nil];
...
- (void)disEnterBackground:(NSNotification*)notification{
    [self resetCompressionSession];
}
